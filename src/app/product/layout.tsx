...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://next-fullstack-gen1.vercel.app/product",
    siteName: "Next Fullstack Gen1",
    locale: "en_US",
    type: "website",
    images: [
      {
        url: "https://i.pinimg.com/736x/d9/5c/d0/d95cd04d85043401df2b957eeba934cd.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Car Selling | Product Page",
    description: "Explore premium features, hybrid engine, and more. Available now in Cambodia.",
    creator: "Next Fullstack Team",
    images: [
